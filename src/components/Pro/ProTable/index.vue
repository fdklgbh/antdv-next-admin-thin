...
const tableExpandable = computed(() => {
  ...
  if (
    ...
    (expandIconColumnIndex !== undefined && typeof expandIconColumnIndex !== 'number') ||
    (typeof expandIconColumnIndex === 'number' && expandIconColumnIndex < 0)
  ) {
    return expandable;
  }
  ...
  return {
    ...expandable,
    expandIconColumnIndex:
      typeof expandIconColumnIndex === 'number' ? expandIconColumnIndex + 1 : 1,
  };
});
