export default {
  ...
  menu: {
    ...
    externalLink: '外部リンク',
    externalTypescript: 'TypeScript',
    externalAntdvNext: '次へ',
    externalVite: 'ヴィーテ',
    externalVue: 'Vue.js',
  },
  layout: {
  ...
  examples: {
    scaffold: {
      ...
      testing: {
        ...
        step2Description: '検索、フォーム、リスト、詳細などの重要なユーザーパスをカバーします。',
        step3Title: 'CIとの統合',
        step3Description:
      ...
      advancedFilter: {
        ...
        statusInactive: '非アクティブ',
        statusPending: '保留中',
        departmentEngineering: '開発部',
        departmentOperations: '運用部',
        departmentSupport: 'サポート部',
        opContains: '含まれています',
        opEquals: '等しい',
        opNotEquals: '等しくない',
        opIn: 'で',
