export default {
  ...
  external: {
    link: {
      openedTitle: 'Opened in a new tab',
      openedSubTitle:
  ...
  examples: {
    scaffold: {
      ...
      testing: {
        ...
        step2Description: 'Cover critical user paths like search, forms, lists, and details.',
