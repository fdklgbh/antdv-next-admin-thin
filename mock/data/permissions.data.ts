...
export const mockPermissions: Permission[] = [
  ...
  {
    id: '60',
    name: localizedName('权限管理', 'Permission Management', '権限管理', '권한 관리'),
    code: 'organization.menu',
    description: 'Permission management root menu',
  ...
  // Examples Menu
  {
    ...
    children: [
      ...
      {
        id: '50',
        name: localizedName('图标库', 'Icon Library', 'アイコンライブラリ', '아이콘 라이브러리'),
        code: 'examples.iconLibrary.view',
        description: 'Icon library menu',
        resource: '/examples/icon-library',
        action: 'view',
        type: 'menu',
        parentId: '40',
        path: '/examples/icon-library',
        component: 'examples/icon-library/index',
        icon: 'antdv-next:AppstoreOutlined',
        sort: 3,
        status: 'inactive',
        visible: false,
